TString simfilename = "bkg.root";
TString cetreefilename = "cetree_bkg.root";
TString outfilename = "cetree_bkg_addparam.root";
...
void add_param(){
    ...
    TFile *hittree_file = new TFile("bkg.root", "r");
    TTree *hittree = (TTree*)hittree_file->Get("hittree");

    TFile *cetree_file = new TFile("cetree_bkg.root", "r");
    ...
    TFile *out_file = new TFile("cetree_bkg_addparam.root", "recreate");
